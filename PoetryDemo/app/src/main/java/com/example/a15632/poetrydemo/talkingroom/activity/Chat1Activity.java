...
import com.example.a15632.poetrydemo.talkingroom.adapter.ChatAdapter;
import com.example.a15632.poetrydemo.talkingroom.bean.AudioMsgBody;
import com.example.a15632.poetrydemo.talkingroom.bean.FileMsgBody;
import com.example.a15632.poetrydemo.talkingroom.bean.ImageMsgBody;
import com.example.a15632.poetrydemo.talkingroom.bean.Message;
import com.example.a15632.poetrydemo.talkingroom.bean.MsgSendStatus;
import com.example.a15632.poetrydemo.talkingroom.bean.MsgType;
import com.example.a15632.poetrydemo.talkingroom.bean.TextMsgBody;
import com.example.a15632.poetrydemo.talkingroom.bean.VideoMsgBody;
import com.example.a15632.poetrydemo.talkingroom.util.ChatUiHelper;
import com.example.a15632.poetrydemo.talkingroom.util.FileUtils;
import com.example.a15632.poetrydemo.talkingroom.util.LogUtil;
import com.example.a15632.poetrydemo.talkingroom.util.PictureFileUtil;
import com.example.a15632.poetrydemo.talkingroom.widget.MediaManager;
import com.example.a15632.poetrydemo.talkingroom.widget.RecordButton;
import com.example.a15632.poetrydemo.talkingroom.widget.StateButton;
...
import com.chad.library.adapter.base.BaseQuickAdapter;
import com.example.a15632.poetrydemo.R;
import com.example.a15632.poetrydemo.talkingroom.adapter.Chat1Adapter;
import com.example.a15632.poetrydemo.talkingroom.adapter.ChatAdapter;
import com.example.a15632.poetrydemo.talkingroom.bean.AudioMsgBody;
import com.example.a15632.poetrydemo.talkingroom.bean.FileMsgBody;
import com.example.a15632.poetrydemo.talkingroom.bean.ImageMsgBody;
...
public class Chat1Activity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    LinearLayout mLlAdd;//添加布局
     ...
     private ImageView iv_talkingback;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_talkingback = findViewById(R.id.talking_back);
        iv_talkingback.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void initContent() {
        ...
        mAdapter=new Chat1Adapter(this, new ArrayList<Message>());
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                final  boolean isSend = mAdapter.getItem(position).getSenderId().equals(Chat1Activity.mSenderId);
                 if (ivAudio != null) {
                    if (isSend){
                    ...
                    drawable.start();
                     MediaManager.playSound(Chat1Activity.this,((AudioMsgBody)mAdapter.getData().get(position).getBody()).getLocalPath(), new MediaPlayer.OnCompletionListener() {
                        @Override
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btn_send:
                ...
                break;
            case R.id.rlPhoto:
                PictureFileUtil.openGalleryPic(Chat1Activity.this,REQUEST_CODE_IMAGE);
                break;
            case R.id.rlVideo:
                PictureFileUtil.openGalleryAudio(Chat1Activity.this,REQUEST_CODE_VEDIO);
                break;
            case R.id.rlFile:
                PictureFileUtil.openFile(Chat1Activity.this,REQUEST_CODE_FILE);
                break;
