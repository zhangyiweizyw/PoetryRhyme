package com.example.a15632.poetrydemo.talkingroom.emoji;

import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;


import com.example.a15632.poetrydemo.talkingroom.MyApplication;
...
public class EmojiDao {
    ...
    public static String CopySqliteFileFromRawToDatabases(String SqliteFileName) throws IOException {
        ...
        //复制的话这里需要换成自己项目的包名
        File dir = new File("data/data/" + "com.example.a15632.poetrydemo" + "/databases");
