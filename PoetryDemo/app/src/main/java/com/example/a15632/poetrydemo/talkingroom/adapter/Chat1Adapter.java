package com.example.a15632.poetrydemo.talkingroom.adapter;
...
import com.example.a15632.poetrydemo.talkingroom.bean.MsgBody;
...
import com.example.a15632.poetrydemo.talkingroom.util.GlideUtils;
...
public class Chat1Adapter extends BaseQuickAdapter<Message, BaseViewHolder> {
    ...
    private static final int RECEIVE_TEXT = R.layout.item_text_receive1;
   ...
   private static final int RECEIVE_AUDIO = R.layout.item_audio_receive;
    ...
    public Chat1Adapter(Context context, List<Message> data) {
        super(data);
